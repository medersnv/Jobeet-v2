...
//        $job_sensio_labs->setExpiresAt(new \DateTime('2022-12-08'));
//
...
//        $job_extreme_sensio->setExpiresAt(new \DateTime('2022-12-08'));
//
//        $job_expired = new Job();
...
//        $job_expired->setCreatedAt(new \DateTime('20010-12-01'));
//
...
////        {
////            $job = new Job();
////            $job->setCategory($em->merge($this->getReference('category-web-designer')));
